    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li>
            <a href="../user/index">User Panel</a>
          </li>
          <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-bs-toggle="dropdown"
              aria-expanded="false">
              <img class="img-xs rounded-circle ms-2" src="assets/images/faces/face8.jpg" alt="Profile image"> <span
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item navbar-brand-mini-wrapper">
            <a class="nav-link navbar-brand brand-logo-mini" href="index.php"><img src="assets/images/logo-mini.svg"
                alt="logo" /></a>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="manage-users">Manage User</a></li>                        
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth1">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="manage-categories">Manage Categories</a></li>                        
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#auth2" aria-expanded="false" aria-controls="auth">
              <span class="menu-title">Manage Subcategory</span>
              <i class="icon-disc menu-icon"></i>
            </a>
            <div class="collapse" id="auth2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="add-subcategory">Add Subcategory</a></li>                        
                <li class="nav-item"> <a class="nav-link" href="manage-subcategories">Manage Subcategories</a></li>                        
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth3">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="add-products">Add Products</a></li>                        
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#auth4" aria-expanded="false" aria-controls="auth">
              <span class="menu-title">Manage User Payments</span>
              <i class="icon-disc menu-icon"></i>
            </a>
            <div class="collapse" id="auth4">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="add-user-payments">Add User Payments</a></li>                        
                <li class="nav-item"> <a class="nav-link" href="manage-user-payments">Manage User Payments</a></li>                        
              </ul>
            </div>
          </li>
