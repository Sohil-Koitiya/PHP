...
<div class="page-heading header-text">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <span class="breadcrumb"><a href="#">Home</a> / <?php echo $fetch->prd_name ?></span>
        <h3><?php echo $fetch->prd_name ?></h3>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      <div class="col-lg-8">
        <div class="main-image">
          <img src="assets/images/<?php echo $fetch->prd_image ?>" alt="">
        </div>
        <form action="addtocart?subcate_id" method="post">
          <div class="main-content">
            <span class="category"><?php echo $fetch->prd_name ?></span>
            <div class="my-3">
              Price : <h2><?php echo $fetch->prd_price ?></h2>
            </div>
            <div>
              <input type="number" class="my-3" name="qty" min="1" max="5" value="1"> <br>
            ...
            <div>
              <input type="submit" class="btn btn-warning my-3" name="addtocart" value="Add to Cart">
            </div>
            ...
            <p>Get <strong>the best villa agency</strong> HTML CSS Bootstrap Template for your company website.
              TemplateMo
              provides you the <a href="https://www.google.com/search?q=best+free+css+templates" target="_blank">best
                free
                CSS templates</a> in the world. Please tell your friends about it. Thank you. Cloud bread kogi bitters
              pitchfork shoreditch tumblr yr succulents single-origin coffee schlitz enamel pin you probably haven't
              heard
              of them ugh hella.

              <br><br>When you look for free CSS templates, you can simply type TemplateMo in any search engine website.
              In addition, you can type TemplateMo Digital Marketing, TemplateMo Corporate Layouts, etc. Master cleanse
              +1
              intelligentsia swag post-ironic, slow-carb chambray knausgaard PBR&B DSA poutine neutra cardigan hoodie
              pop-up.
            </p>
          </div>
        </form>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
              ...
              <div class="accordion-body">
                ...
                tonx seitan crucifix 3 wolf moon bicycle rights keffiyeh snackwave wolf same vice, chillwave
                vexillologist incididunt ut labore consectetur <code>adipiscing</code> elit, sed do eiusmod tempor
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, do eiusmod tempor pack incididunt ut
                      ...
                      chillwave vexillologistlabore et dolore magna aliqua quised ipsum suspendisse. <br><br>Swag fanny
                      pack lyft blog twee. JOMO ethical copper mug, succulents typewriter shaman DIY kitsch twee taiyaki
                      fixie hella venmo after messenger poutine next level humblebrag swag franzen.</p>
                    <div class="icon-button">
                      <a href="#"><i class="fa fa-calendar"></i> Schedule a visit</a>
                    </div>
                  </div>
