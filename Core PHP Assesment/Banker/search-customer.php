...
<body>
  ...
  <thead>
    <form method="post" action="searcheach-customer.php">
    <tr>
      <td colspan="3">
        <input type="text" name="searchname" style="width: 500px;"> &nbsp;<button type="submit" name="searchbtn" class="btn btn-warning">Search</button>
      </td>
    </tr>
    </form>
